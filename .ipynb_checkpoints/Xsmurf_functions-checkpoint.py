    ...
    class chain:
        ...
        def show(self):
            ...
            try:
                ...
                print("no class variable, 'metric'.") 
            #print('Metric:', self.metric) # Couldn't figure out what this was, but it caused an error
            print('Arguments:', self.args)
            print('ix:', self.ix)
            print('iy:', self.iy)
            print('scale number:', scale)
            print('mean args:', self.meanarg)
